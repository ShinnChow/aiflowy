...
import tech.aiflowy.admin.controller.wiki.WikiOptimizeDto;
 ...
 * Wiki知识树
 */
@RequestMapping("/public-api/v1/wiki")
@RestController
public class PublicWikiController extends BaseCurdController<WikiService, Wiki> {
    ...
    public PublicWikiController(WikiService service) {
        super(service);
    }
